...
class HaikuChecker(
    ...
    private val spokenPrompt = """
        ...
        — **числа, время и единицы приходят цифрами и сокращениями.** Движок
        отдаёт «у седам сати» как «7:00h», «двадесет евра» как «20 EUR»,
        «два килограма» как «2 kg». Это не ошибка ученика и не небрежность:
        так работает распознавание, и сказать иначе он не может. Засчитывай
        и никогда не требуй «словами» или «без сокращений».
        — **ответ произнесён, а не написан.** Поля ввода на этом задании нет
        вовсе, поэтому «надо написать», «исправь написание», «пропущена буква»
        — советы, которые ученику нечем выполнить. Говори только о словах и
        смысле.
