...
class Pace(context: Context) {
    ...
    companion object {
        ...
        private val DEFAULTS = mapOf(
            ...
            // и не одно.
            "match" to 40.0,
            // Четыре ячейки за раз — дольше одного задания на форму, но
            // заметно быстрее экрана пар: ответ печатают, а не ищут.
            "paradigm" to 45.0,
            // Показ ничего не спрашивает: посмотреть и нажать «Понятно».
            "paradigm_show" to 12.0,
            "listening" to 26.0,
            "speaking" to 18.0,
            "repeat" to 16.0,
            "reading" to 55.0,
